...
module.exports = {
    ...
    re: [
    	/^https?:\/\/tube\.geogebra\.org\/material\/\w+\/id\/([a-zA-Z0-9]+)/i,
    	/^https?:\/\/tube\.geogebra\.org\/m\/([a-zA-Z0-9]+)/i,
    	/^https?:\/\/tube\.geogebra\.org\/student\/m([a-zA-Z0-9]+)/i,
    	/^https?:\/\/\w+\.geogebra\.org\/m\/([a-zA-Z0-9]+)/i    	
    ],
