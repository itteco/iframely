module.exports = {
    ...
    getData: function(url, og, whitelistRecord) {
        ...
        if (video_src && !(video_src instanceof Array)
            && /(youtube|youtu|vimeo|dailymotion|theplatform|jwplatform|jwplayer|cnevids|newsinc|wistia|kaltura|mtvnservices|bcove|viddler|flowplayer|vidible)\./i.test(video_src)
