module.exports = {
    ...
    getData: function(url, twitter, whitelistRecord) {
        ...
        if (video_src && typeof video_src === "string" 
            && /(youtube|youtu|youtube\-nocookie|vimeo|dailymotion|theplatform|jwplatform|cnevids|newsinc|podbean|simplecast|libsyn|wistia|podiant|art19)\./i.test(video_src)
            && !/(youtube|youtu|youtube\-nocookie|vimeo|dailymotion|theplatform|jwplatform|cnevids|newsinc|libsyn|wistia|podiant|art19)\./i.test(url)) {
