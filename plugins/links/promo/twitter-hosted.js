module.exports = {
    ...
    getData: function(url, twitter, whitelistRecord) {
        ...
        if (video_src && typeof video_src === "string" 
            && /(youtube|youtu|youtube\-nocookie|vimeo|dailymotion|theplatform|jwplatform|jwplayer|cnevids|newsinc|podbean|simplecast|libsyn|wistia|podiant|art19|kaltura|mtvnservices|bcove|soundcloud|giphy|viddler|flowplayer|vidible|bandzoogle)\./i.test(video_src)
