...
var prepareRequestOptions = exports.prepareRequestOptions = function(request_options, options) {
    ...
    var lang = options && options.getProviderOptions && options.getProviderOptions('request.lang');
    if (lang) {
        request_options.headers['Accept-Language'] = lang + CONFIG.ACCEPT_LANGUAGE_POSTFIX;
    }
