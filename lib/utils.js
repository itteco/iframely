...
export function prepareRequestOptions(request_options, options) {
    return new Promise((resolve, reject) => {
        try {
            ...
            const forward_sig = options?.getProviderOptions && options.getProviderOptions('app.http_forward_sig');
            ...
            if (!forward_sig && (options?.sig || request_sig) && options?.getSigHeaders) {
                try {
