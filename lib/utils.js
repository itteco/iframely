...
export function getUrlFunctional(url, options, callbacks) {
    ...
    getUrl(url, options)
        ...
        .on('response', function(response) {
            // TODO: remove abort event
            callbacks.onAbortController && callbacks.onAbortController(response.abortController);
        ...
        try {
            ...
            var request_options = prepareRequestOptions({
                ...
                headers: {
                    ...
                    'Accept': '*/*'
                    // gzip, br, etc - set by `node-fetch` default `compress: true` option.
                },
