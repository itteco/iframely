            ...
            fetch(request_options.url || request_options.uri, request_options)
                .then(res => {
                    ...
                    if (contentEncoding === 'br') {
                        ...
                        // TODO:
                        gunzip.statusCode = res.status;
                        gunzip.headers = headers;
                    ...
                    if (!method
                        ...
                        && (error === 405 
                            ...
                            || (res.headers && !res.headers.get('access-control-allow-origin')
                                && res.headers.get('server') === 'AmazonS3' && !error ))) {
                        makeCall('GET');
                        return;
                    }
