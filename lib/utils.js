...
exports.parseJSONSource = function(text, decode) {
    var s = decode ? decode(text) : text;
    s = entities.decodeHTML(s);
    ...
    // escape apostrophies as in dont't-> don\'t
    s = s.replace(/(\w)\'(\w)/gm, "$1\'$2");    
    ...
    cache.withCache("content-type:" + uriForCache, function(cb) {
        ...
        function finish(error, headers) {
            ...
            if (headers) {
                ...
                if (headers['location']) data.href = headers['location'];  
            }
        ...
        function makeCall(method) {
            ...
            methodCaller(uriOriginal, {
                ...
                .on('response', function(res) {
                    ...
                    if (res.request && res.request.href && res.headers) {
...
exports.generateLinksHtml = function(data, options) {
    ...
    options = _.extend({}, options, {iframeAttributes: {'allow': 'autoplay; encrypted-media'}});
