...
exports.renderPluginTemplate = function(template_id, template_context, templates) {
    ...
    var template = getFile(templates[template_id]);
    var html = ejs.render(template, template_context);
