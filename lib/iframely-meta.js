                ...
                request({
                    ...
                    .on('response', function(res) {
                        ...
                        if (['gzip', 'deflate'].indexOf(res.headers['content-encoding']) > -1) {
                            ...
                            // Transform parser stream needed to support .setEncoding("binary") method on Unzip class.
                            var parser = new Transform();
                            parser.request = res.request;
                            parser.statusCode = res.statusCode;
                            parser.headers = res.headers;
                            parser.setEncoding("binary");
                            ...
                            if (options.fullResponse) {
                                bindBodyGetter(parser);
                            }

                            req.emit('response', parser);
