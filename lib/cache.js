(function(cache) {
    ...
    * */
    ...
    var MultiCache = cache.MultiCache = function(options) {
    ...
    MultiCache.prototype.runAllGets = function() {
        ...
        this.multiKey = _.keys(this.keysDict).sort().join(':');
    ...
    MultiCache.prototype._runAllSets = function() {
        ...
        cache.set(this.multiKey, this.setDict, this.options);
    };
