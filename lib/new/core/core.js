(function(core) {
    ...
    * */
    ...
    function useResult(usedMethods, context, pluginsContexts, allResults, result, asyncMethodCb) {
    ...
    function run(uri, options, cb) {
        ...
        var requiredPlugins = pluginsSet.initialPlugins,
            ...
            asyncMethodCb = function(error, result) {
                ...
                // Gather results.
                var hasNewData = useResult(usedMethods, context, pluginsContexts, allResults, result, asyncMethodCb);
