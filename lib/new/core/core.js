(function(core) {
    ...
    function runPlugins(requiredPlugins, secondaryPlugins, context, pluginsUrlMatches, usedMethods, usedParams, asyncMethodCb) {
        ...
        requiredPlugins.forEach(function(plugin) {
            findPluginMethods(plugin, loadedParams, pluginsUrlMatches, usedMethods, usedParams, methods, scannedPluginsIds);
        });
        ...
        if (mandatoryParams && mandatoryParams.length > 0) {
            ...
            secondaryPlugins.forEach(function(plugin) {
                findPluginMethods(plugin, loadedParams, pluginsUrlMatches, usedMethods, usedParams, methods, scannedPluginsIds, mandatoryParams, requiredPlugins);
            });
        }
