...
function Http2ServerResponseWrapper(clientHttp2Stream) {
...
util.inherits(Http2ServerResponseWrapper, stream.Transform);

Http2ServerResponseWrapper.prototype._transform = function (chunk, enc, cb) {
    this.push(chunk);
    cb();
};

exports.Http2ServerResponseWrapper = Http2ServerResponseWrapper;
