(function() {
    ...
    var generateLinkElementHtml = exports.generateLinkElementHtml = function(link, options) {
    ...
    var sortLinks = function(links, autoplay_first) {
    ...
    function getPlayer(iframely_data, options) {
        ...
        if (iframely_data) {
            sortLinks(iframely_data.links, options.prioritizeAutoplay);
        }
        ...
        if (player) {
            ...
            if (html5video || player.rel.indexOf('autoplay') > -1) {
                ...
                if (!has_aspect_ratio && width && height) {
                    var image;
                    if (player.rel.indexOf('app') > -1 && (image = getImage(link, res, test))) {
                        return image;
                    }
                }
            }
    ...
    exports.generateMainHtml = function(iframely_data, options) {
        ...
        if (selectedLink && selectedLink.html) {
