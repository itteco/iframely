        ...
        "iframe": {
            ...
            generate: function(data, options) {
                ...
                if (options.amp) {
                    ...
                    $iframe.html('<div overflow tabindex=0 role=button aria-label="Read more">Read more</div>');
                } else {
                    $iframe = $('<iframe>')
                        .attr('src', data.href)
                        .attr('frameborder', '0')
                ...
                var allow = 'encrypted-media';
                if ((options && options.autoplayMode) || (data.rel && data.rel.indexOf && data.rel.indexOf('autoplay') > -1)) {
                    allow = 'autoplay; ' + allow;
                }
