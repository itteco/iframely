(function() {
    ...
    var defaultPaddingBottom = 56.25;
    ...
    function wrapContainer($element, data, options) {
        ...
        var hasMaxWidth = media && (media["max-width"] || media["min-width"]);
        ...
        if (!omitInlineStyles) {
            ...
            if (hasMaxWidth) {
                $widthLimitContainer.css('width', '100%');
            }
        }
        ...
        if (media) {
            ...
            if (media["aspect-ratio"]) {
                ...
                var defaultAspectDeclared = omitInlineStyles && aspectWrapperClass;
