(function() {
    ...
    function wrapContainer($element, data, options) {
        ...
        var verticalAspect = media && media["aspect-ratio"] && media["aspect-ratio"] <= maxVerticalAspect;
        ...
        if (media) {
            ...
            if (media["max-width"]) {
                ...
                $widthLimitContainer.css("max-width", Math.round(media["aspect-ratio"] * 90) + 'vh');
            }
