    ...
    * */
    ...
    function getAllDataFromPlugins(uri, options, callback) {
        ...
        async.waterfall([
            ...
            function(data, cb) {
                ...
                if ('$selector' in initialRequirements) {
                    if (data.fullResponse) {
                        ...
                        registerCall && registerCall('context_selector_init');
                        ...
                        jsdom.env({
                            ...
                            features: {
                                ...
                                registerCall && registerCall('context_selector_created');
            ...
            function(data, context, cb) {

                if ('$empty' in initialRequirements) {
                    registerCall && registerCall('context_empty_init');
                    ...
                    jsdom.env({
                        ...
                        features: {
                            ...
                            context.$empty = window.$;

                            // Store window instance in context to close window.
                            context.$empty._window = window;

                            registerCall && registerCall('context_empty_created');
            ...
            function(cb) {
                ...
                if (initialContext.$selector) {
                    registerCall && registerCall('context_selector_close');
                    initialContext.$selector._window.close();
                }
                if (initialContext.$empty) {
                    registerCall && registerCall('context_empty_close');
                    initialContext.$empty._window.close();
                }
