        ...
        async.waterfall([
            ...
            function(data, cb) {
                ...
                if ('$selector' in initialRequirements) {
                    if (data.fullResponse) {
                        ...
                        registerCall('context_selector_init');
                        ...
                        jsdom.env({
                            ...
                            features: {
                                ...
                                registerCall('context_selector_created');
            ...
            function(data, context, cb) {
                ...
                if ('$empty' in initialRequirements) {
                    registerCall('context_empty_init');
                    ...
                    jsdom.env({
                        ...
                        features: {
                            ...
                            registerCall('context_empty_created');
            ...
            function(cb) {
                ...
                if (initialContext.$selector) {
                    registerCall('context_selector_close');
                    initialContext.$selector._window.close();
                }
                if (initialContext.$empty) {
                    registerCall('context_empty_close');
