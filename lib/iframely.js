(function(proxy) {
    ...
    proxy.getRawLinks = function(uri, options, cb) {
        ...
        var loadImageMetaTime, getAllDataFromPluginsTime;

        async.waterfall([

            function(cb) {

                startTimer("getAllDataFromPluginsTime");
            ...
            function(data, cb) {
                ...
                getAllDataFromPluginsTime = getTimer("getAllDataFromPluginsTime");
            ...
            function(data, cb) {
                ...
                loadImageMetaTime = getTimer("loadImageMetaTime");
                ...
                cb(null, {
                    time: {
                        loadImageMeta: loadImageMetaTime,
                        getAllDataFromPlugins: getAllDataFromPluginsTime
                    },
                    meta: meta,
                    links: links,
                    debug: data,
