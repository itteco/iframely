(function(pluginLoader) {
    ...
    function loadPluginFile(pluginPath) {
        ...
        if (pluginPath.match(/\.js$/i)) {
            ...
            // Plugins in foler 'custom' or 'core' will be run only on explicit dependency.
            pluginDeclaration.custom = bits.indexOf('custom') > -1 || bits.indexOf('core') > -1;
