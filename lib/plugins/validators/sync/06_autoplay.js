...
module.exports = {
    ...
    prepareLink: function(link) {
        ...
        if (link.href && link.rel.indexOf(CONFIG.R.player) > -1 && link.autoplay && typeof link.autoplay === "string" && link.autoplay.indexOf('=') > -1) { // it should always be a query-string
            ...
            console.log('start prepare link ....');
            ...
            if (link.href.indexOf (play) > -1 ) { //original link is autoplay
                ...
                console.log('newlink rel' + new_link.rel);

            } else { // original link isnt autoplay
            ...
            console.log('new link=' + JSON.stringify(new_link)); // TODO: @nleush here pls
            console.log('original=' + JSON.stringify(link)); // TODO: @nleush here pls
