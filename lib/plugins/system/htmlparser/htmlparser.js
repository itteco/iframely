...
import { TextResponseHandler } from './TextResponseHandler.js';
    ...
    getData: function(url, whitelistRecord, options, __noCachedHtmlparserFallback, cb) {
        ...
        getUrlFunctional(url, options2, {
            ...
            onResponse: function(resp) {
                ...
                var responseTextHandler;
                if (options.enableTextResponseHandler) {
                    // Collect full response text.
                    responseTextHandler = new TextResponseHandler();
                    // Bind on data, on end.
                    responseTextHandler.attach(resp);

                    result.textresponse = responseTextHandler;
                }
