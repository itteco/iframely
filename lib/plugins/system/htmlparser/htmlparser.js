...
module.exports = {
    ...
    getData: function(url, options, __noCachedNonHtmlContentData, cb) {
        ...
        getUrl(url, _.extend({}, options, {
            ...
            .on('response', function(resp) {
                ...
                if('content-type' in resp.headers && !/text\/html|application\/xhtml\+xml/gi.test(resp.headers['content-type'])){
                    ...
                    var nonHtmlContentData = {
                        type: resp.headers['content-type'],
                        content_length: resp.headers['content-length']
                    };

                    cache.set(nonHtmlContentData_key, nonHtmlContentData);

                    return cb(null, {
                        nonHtmlContentData: nonHtmlContentData
                    });

                } else {
                    // Store empty nonHtmlContentData data.
                    cache.set(nonHtmlContentData_key, {});
                }
