    ...
    * */
    ...
    function prepareResultData(uri, result, options) {
        ...
        if (options.debug_sources) {
            ...
            getSourcesParams(result.meta._sources, result._debug.meta_dependencies, 'getMeta');
            getSourcesParams(result.vars._sources, result._debug.vars_dependencies, 'getVars');
        }
