    ...
    * */
    ...
    function getQueryOptionsFromQuery(queryEntries) {
        const _RE = /^_.+/;
        /*
    ...
    function getQueryOptionsFromUrl(url) {
        try {
            return getQueryOptionsFromQuery(new URL(url).searchParams);
        } catch(ex) {
    ...
    function generateProviderOptionsFunc(url, options) {
        ...
        options.getQueryOptions = function() {
            const requestOptions = getQueryOptionsFromQuery(new URLSearchParams(options.providerOptions || {}));
            var query = {...requestOptions, ...urlOptions}
