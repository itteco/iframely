        ...
        if (!mandatoryParams) {
            ...
            if (mixins) {
                for(var i = 0; i < mixins.length; i++) {
                    findPluginMethods({pluginId: mixins[i], loadedParams, pluginsUrlMatches, usedMethods, usedParams, methods, scannedPluginsIds, usedDomains});
                }
            }
        }
            ...
            if (method in plugin.methods) {
                ...
                if (absentParams.length > 0) {
                    ...
                    for(var j = 0; j < pluginsId.length; j++) {
                        ...
                        findPluginMethods({pluginId: foundPluginId, loadedParams, pluginsUrlMatches, usedMethods, usedParams, methods, scannedPluginsIds, usedDomains});
                    }
