    ...
    * */
                ...
                if (!(r.data instanceof Object)) {
                    ...
                    for(var key in r.data) {
                        ...
                        if (v !== '' && v !== null) {
                            ...
                            var prevOrder, nextOrder, pluginId = allResults.meta._sources[key];
    ...
    function prepareResultData(uri, result, options) {
        ...
        for(var i = 0; i < links.length;) {
            ...
            // Remove canonical links.
            if (canonical && link.href && typeof link.href === 'string' && link.rel.indexOf('file') === -1) {
