(function(core) {
    ...
    * */
    ...
    function runPostPlugins(link, dataRecord, usedMethods, context, pluginsContexts, options, asyncMethodCb) {
        ...
        for(var i = 0; i < result.length; i++) {
            ...
            if (r.data && !r.error && r.method.name === 'getLink' || r.method.name === 'getLinks' || r.method.name === 'prepareLink') {
                ...
                for(var j = 0; j < links.length; j++) {
                    ...
                    runPostPlugins(link, r, usedMethods, context, pluginsContexts, options, asyncMethodCb);
                }

                // TODO: finishIteration
            }
        }
    ...
    * */
    var run = core.run = function(uri, options, cb) {
        ...
        function requestWrapperWithParams(options_from_plugin, callback) {
            ...
            requestWrapper(options_from_plugin, callback);
        }
