    ...
    function findPluginMethods(opts) {
        const {pluginId, loadedParams, pluginsUrlMatches, usedMethods, usedParams, methods, scannedPluginsIds, usedDomains, mandatoryParams} = opts;
    ...
    * */
    function runPluginsIteration({requiredPlugins, context, pluginsUrlMatches, usedMethods, usedParams, usedDomains, options, asyncMethodCb}) {
        ...
        for(var i = 0; i < requiredPlugins.length; i++) {
            ...
            findPluginMethods({pluginId: plugin.id, loadedParams, pluginsUrlMatches, usedMethods, usedParams, methods, scannedPluginsIds, usedDomains});
        }
