    ...
    * */
    ...
    function generateMakeFetchFunc(options) {
        if (options.returnExtra && !options.markFetch) {
            options.markFetch = function() {
                options._fetch = true;
            };
        }
    }
