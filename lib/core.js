    ...
    * */
    ...
    function prepareResultData(uri, result, options) {
        ...
        if (!options.debug && !options.debug_sources) {
            ...
            result.meta._sources_params = result.meta._sources_params || {};
            result.vars._sources_params = result.vars._sources_params || {};
            getSourcesParams(result.meta._sources, result.meta._sources_params, 'getMeta');
            getSourcesParams(result.vars._sources, result.vars._sources_params, 'getVars');
        }
