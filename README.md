...
The whitelist file is pulled from iframely.com and is updated automatically. You can also [have your own whitelist](/docs/QA%20Whitelist%20Format.md) file. The whitelisting is manual process, and we do every-day manual regression testing to ensure integrity. [Submit your domain](https://iframely.com/qa/request), if you publish embeds.
